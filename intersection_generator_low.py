...
OUTPUT_FILE = "intersection_low.mp4"

BG_COLOR = (80, 140, 70)       # Rich grass
ROAD_COLOR = (70, 75, 80)      # Dark realistic asphalt
...
class IntersectionSimulator:
    ...
    _SPAWN_INTERVAL = 120                   # frames between spawn attempts (~1.5s at 30fps)
    ...
    def next_frame(self):
        ...
        if cycle_frame < TOTAL_FRAMES - 300:
            self._spawn_timer += 1
